            ...
            <section className="mb-10 text-center text-lg-start">
              ...
              <div className="container py-4">
                <div className="row g-0 align-items-center">
                    ...
                    >
                      <div className="card-body px-4 pb-5 pt-md-0 px-md-5 shadow-5">
                        <h1 className="my-5 display-4 fw-bold ls-tight">
                          <span className="text-dark">Build your Brand</span> <br />
                  ...
                  <div className="col-lg-6 mb-5 mb-lg-0">
                    <img
                      src="https://realwealthbusiness.com/wp-content/uploads/2018/03/business-concept-with-copy-space-office-desk-table-with-pen-focus-analysis-chart-computer-notebook-cup-coffee-desk-vintage-tone-retro-filter-selective-focus_1418-536.jpg.webp"
              ...
              <div className="row gx-lg-5 align-items-center">
                <div className="col-lg-5 mb-5 mb-lg-0">
                  <div
                    ...
                    style={{
                      backgroundImage:
                        'url("https://img.freepik.com/free-vector/preferences-concept-illustration_114360-1384.jpg?w=2000")',
                      height: 560,
